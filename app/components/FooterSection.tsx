    ...
    <footer className="bg-navy">
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-semibold text-cream mb-4">Onze diensten</h3>
          ...
          {/* Quick links */}
          <div>
            <h3 className="text-lg font-semibold text-cream mb-4">Snelle links</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-navy-light pt-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-cream-light">
              &copy; 2025 Groepspraktijk Het Huis. Alle rechten voorbehouden.
            </p>
          </div>
        </div>
      </div>
